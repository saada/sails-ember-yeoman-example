...
*/
Ember.deprecateFunc = (message, func) => function(...args) {
...
((() => {
  ...
  */
  ...
  if ('undefined' === typeof Ember.deprecateFunc) {
    Ember.deprecateFunc = (_, func) => func;
  }
  ...
  */
  ...
  /**
    ...
    @return {Boolean}
  */
  Ember.isNone = obj => obj === null || obj === undefined;
  ...
  /**
    ...
    @return {Boolean}
  */
  Ember.isEmpty = obj => obj === null || obj === undefined || (obj.length === 0 && typeof obj !== 'function') || (typeof obj === 'object' && Ember.get(obj, 'length') === 0);
  ...
  ((() => {
    ...
    */
    ...
    var canRedefineProperties;
    var canDefinePropertyOnDOM;

    // Catch IE8 where Object.defineProperty exists but only works on DOM elements
    if (defineProperty) {
      try {
        defineProperty({}, 'a',{get() {}});
      } catch (e) {
        defineProperty = null;
      }
    }
    ...
    */
    ...
    if (!platform.defineProperty) {
      ...
      platform.defineProperty = (obj, keyName, desc) => {
  ...
  ((() => {
    ...
    */
    Ember.wrap = (func, superFunc) => {
      function K() {}

      function superWrapper(...args) {
        var ret;
        var sup = this._super;
  ...
  ((() => {
    ...
    */
    ...
    var time = ((() => {
      ...
      return fn ? fn.bind(perf) : () => +new Date();
    }))();


    Ember.Instrumentation.instrument = (name, payload, callback, binding) => {
    ...
    Ember.Instrumentation.subscribe = (pattern, object) => {
  ...
  var utils = Ember.EnumerableUtils = {
    ...
    indexOf(obj, element, index) {
      return obj.indexOf ? obj.indexOf.call(obj, element, index) : Array.prototype.indexOf.call(obj, element, index);
    },

    indexesOf(obj, elements) {
      return elements === undefined ? [] : utils.map(elements, item => utils.indexOf(obj, item));
    },
  ...
  */
  ...
  var isNativeFunc = func => // This should probably work in all browsers likely to have ES5 array methods
  func && Function.prototype.toString.call(func).indexOf('[native code]') > -1;
  ...
  ((() => {
    ...
    */
    ...
    var copyMap = (original, newObject) => {
    ...
    */
    OrderedSet.create = () => new OrderedSet();
  ...
  ((() => {
    ...
    */
    ...
    function normalizeTuple(target, path) {
      ...
      var isGlobal = !hasThis && IS_GLOBAL_PATH.test(path);
      var key;
    ...
    */
    Ember.normalizeTuple = (target, path) => normalizeTuple(target, path);

    Ember.getWithDefault = (root, key, defaultValue) => {
    ...
    /**
      ...
      @param {Object} value The value to set
    */
    Ember.trySet = (root, path, value) => set(root, path, value, true);
    ...
    /**
      ...
      @return Boolean
    */
    Ember.isGlobalPath = path => IS_GLOBAL.test(path);
  }))();
  ...
  ((() => {
    ...
    */
    ...
    var DEFAULT_GETTER_FUNCTION = Ember.DEFAULT_GETTER_FUNCTION = name => function() {
  ...
  ((() => {
    ...
    */
    ...
    ObserverSet.prototype.add = function(sender, keyName, eventName) {
      ...
      var senderGuid = Ember.guidFor(sender);
    ...
    */
    ...
    /**
      ...
      @param [binding]
    */
    Ember.changeProperties = (cb, binding) => {
      Ember.beginPropertyChanges();
    ...
    */
    ...
    Ember.observersFor = (obj, path) => Ember.listenersFor(obj, changeEvent(path));
    ...
    */
    ...
    Ember._suspendBeforeObserver = (obj, path, target, method, callback) => Ember._suspendListener(obj, beforeEvent(path), target, method, callback);

    Ember._suspendObserver = (obj, path, target, method, callback) => Ember._suspendListener(obj, changeEvent(path), target, method, callback);

    var map = Ember.ArrayPolyfills.map;

    Ember._suspendBeforeObservers = (obj, paths, target, method, callback) => {
      var events = map.call(paths, beforeEvent);
      return Ember._suspendListeners(obj, events, target, method, callback);
    };

    Ember._suspendObservers = (obj, paths, target, method, callback) => {
      var events = map.call(paths, changeEvent);
      return Ember._suspendListeners(obj, events, target, method, callback);
    };

    Ember.beforeObserversFor = (obj, path) => Ember.listenersFor(obj, beforeEvent(path));
  ...
  ((() => {
    ...
    */
    ...
    var // circular reference observer depends on Ember.watch
    ...
    function flushPendingChains() {
      ...
      forEach.call(queue, q => { q[0].add(q[1]); });
    ...
    Ember.overrideChains = (obj, keyName, m) => {
    ...
    */
    function propertyWillChange(obj, keyName) {
      var m = metaFor(obj, false);
      var watching = m.watching[keyName] > 0 || keyName === 'length';
      var proto = m.proto;
  ...
  ((() => {
    ...
    */
    ...
    var o_create = Ember.create;
    var META_KEY = Ember.META_KEY;
    var watch = Ember.watch;
    var unwatch = Ember.unwatch;
    ...
    */
    ...
    function registerComputedWithProperties(name, macro) {
      Ember.computed[name] = function(...args) {
        var properties = a_slice.call(args);

        var computed = Ember.computed(function() {
          return macro.apply(this, [getProperties(this, properties)]);
        });

        return computed.property(...properties);
      };
    }
    ...
    */
    registerComputedWithProperties('and', properties => {
    ...
    */
    registerComputedWithProperties('or', properties => {
      for (var key in properties) {
        if (properties.hasOwnProperty(key) && properties[key]) {
          return true;
        }
    ...
    */
    registerComputedWithProperties('any', properties => {
      for (var key in properties) {
        if (properties.hasOwnProperty(key) && properties[key]) {
    ...
    */
    registerComputedWithProperties('map', properties => {
      var res = [];
      for (var key in properties) {
    ...
    */
    Ember.computed.alias = dependentKey => Ember.computed(dependentKey, function(key, value){
      if (arguments.length > 1) {
    ...
    */
    Ember.computed.defaultTo = defaultPath => Ember.computed(function(key, newValue, cachedValue) {
      var result;
      if (arguments.length === 1) {
  ...
  ((() => {
    ...
    RunLoop.prototype = {
      ...
      */
      ...
      /**
        ...
        @param method
      */
      schedule(queueName, target, method) {
    ...
    */
    ...
    Ember.run.hasScheduledTimers = () => !!(scheduledAutorun || scheduledLater);
    ...
    */
    Ember.run.later = function(target, method) {
      ...
      timer   = { target, method, expires, args };
    ...
    function scheduleOnce(queue, target, method, args) {
      ...
      var mguid = Ember.guidFor(method);
      var onceTimers = run.autorun().onceTimers;
      var guid = onceTimers[tguid] && onceTimers[tguid][mguid];
      var timer;
  ...
  ((() => {
    ...
    */
    ...
    var set     = Ember.set;
    var guidFor = Ember.guidFor;
    var isGlobalPath = Ember.isGlobalPath;
    ...
    */
    Ember.bind = (obj, to, from) => new Ember.Binding(to, from).connect(obj);
    ...
    /**
      ...
      @return {Ember.Binding} binding instance
    */
    Ember.oneWay = (obj, to, from) => new Ember.Binding(to, from).oneWay().connect(obj);
  }))();
  ...
  ((() => {
    ...
    */
    ...
    var a_indexOf = Ember.ArrayPolyfills.indexOf;
    ...
    function initMixin(mixin, args) {
      if (args && args.length > 0) {
        mixin.mixins = a_map.call(args, x => {
    ...
    */
    ...
    /**
      ...
      @namespace Ember
    */
    Ember.Mixin = function(...args) { return initMixin(this, args); };
    ...
    */
    ...
    /**
      ...
      @param arguments*
    */
    MixinPrototype.reopen = function(...args) {
      var mixin;
      var tmp;
    ...
    */
    ...
    MixinPrototype.without = function(...args) {
      ...
      ret._without = a_slice.call(args);
      return ret;
    };
    ...
    function _keys(ret, mixin, seen) {
      ...
      if (mixin.properties) {
        ...
        a_forEach.call(mixin.mixins, x => { _keys(ret, x, seen); });
      }
    }
    ...
    */
    Ember.alias = methodName => new Alias(methodName);
    ...
    /**
      ...
      @return {Ember.Descriptor}
    */
    Ember.aliasMethod = methodName => new Alias(methodName);
    ...
    */
    ...
    /**
      ...
      @return func
    */
    Ember.immediateObserver = function(...args) {
  ...
  define("rsvp",
    ...
    () => {
      ...
      function all(promises) {
        ...
        var resolver = index => value => {
          resolve(index, value);
        };

        var resolve = (index, value) => {
          results[index] = value;
          if (--remaining === 0) {
      ...
      RSVP = { async, Promise, Event, EventTarget, all, raiseOnUncaughtExceptions: true };
      return RSVP;
    });
  ...
  define("container",
    ...
    () => {
      ...
      Container.prototype = {
        ...
        injection(factoryName, property, injectionName) {
          ...
          injections.push({ property, fullName: injectionName });
        },
      ...
      function eachDestroyable(container, callback) {
        container.cache.eachLocal((key, value) => {
  ...
  */
  ...
  Ember.ArrayPolyfills.forEach.call(t, name => {
  ...
  */
  ...
  /**
    ...
    @constructor
  */
  Ember.Error = function(...args) {
    var tmp = Error.prototype.constructor.apply(this, args);
  ...
  */
  Ember.String = {
    ...
    */
    camelize(str) {
      return str.replace(STRING_CAMELIZE_REGEXP, (match, separator, chr) => chr ? chr.toUpperCase() : '').replace(/^([A-Z])/, (match, separator, chr) => match.toLowerCase());
    },
  ...
  if (Ember.EXTEND_PROTOTYPES === true || Ember.EXTEND_PROTOTYPES.Function) {
    ...
    */
    Function.prototype.observes = function(...args) {
      this.__ember_observes__ = a_slice.call(args);
      return this;
    };
    ...
    */
    Function.prototype.observesBefore = function(...args) {
      this.__ember_observesBefore__ = a_slice.call(args);
      return this;
    };
    ...
    Ember.Enumerable = Ember.Mixin.create({
      ...
      */
      ...
      reject(callback, target) {
        return this.filter(function(...args) {
      ...
      */
      rejectProperty(key, value) {
        var exactValue = item => get(item, key) === value;
        var hasValue = item => !!get(item, key);
    ...
    */
    Ember.Array = Ember.Mixin.create(Ember.Enumerable, /** @scope Ember.Array.prototype */ {
      ...
      */
      ...
      objectsAt(indexes) {
        var self = this;
        return map(indexes, idx => self.objectAt(idx));
      },
    ...
    */
    Ember.Observable = Ember.Mixin.create(/** @scope Ember.Observable.prototype */ {
      ...
      */
      getProperties(...args) {
        var ret = {};
        var propertyNames = args;
        if (args.length === 1 && Ember.typeOf(args[0]) === 'array') {
          propertyNames = args[0];
        }
        for(var i = 0; i < propertyNames.length; i++) {
  ...
  */
  ...
  Ember.DeferredMixin = Ember.Mixin.create({
    ...
    */
    ...
    promise: Ember.computed(() => new RSVP.Promise())
  });
  ...
  ((() => {
    ...
    */
    ...
    var finishChains = Ember.finishChains;
    var destroy = Ember.destroy;
    ...
    function makeCtor() {
      ...
      Class._initMixins = args => { initMixins = args; };
      Class._initProperties = args => { initProperties = args; };
    ...
    var ClassMixin = Mixin.create({
      ...
      createWithMixins(...args) {
        var C = this;
        if (args.length>0) { this._initMixins(args); }
        return new C();
      },

      create(...args) {
        var C = this;
        if (args.length>0) { this._initProperties(args); }
        return new C();
      },
      ...
      reopenClass(...args) {
        reopen.apply(this.ClassMixin, args);
        applyMixin(this, args, false);
        return this;
      },
  ...
  */
  ...
  Ember.Object.toString = () => "Ember.Object";
  ...
  ((() => {
    ...
    */
    ...
    var NativeArray = Ember.Mixin.create(Ember.MutableArray, Ember.Observable, Ember.Copyable, {
      ...
      copy(deep) {
        if (deep) {
          return this.map(item => Ember.copy(item, true));
        }
    ...
    var ignore = ['length'];
    Ember.EnumerableUtils.forEach(NativeArray.keys(), methodName => {
  ...
  ((() => {
    var // mixins/deferred
    DeferredMixin = Ember.DeferredMixin;
  ...
  */
  Ember.runLoadHooks = (name, object) => {
    var hooks;

    loaded[name] = object;

    if (hooks = loadHooks[name]) {
      loadHooks[name].forEach(callback => {
        callback(object);
      });
    }
  };
    ...
    Ember.SortableMixin = Ember.Mixin.create(Ember.MutableEnumerable, {
      ...
      */
      ...
      orderBy(item1, item2) {
        ...
        forEach(sortProperties, propertyName => {
          if (result === 0) {
      ...
      arrangedContent: Ember.computed('content', 'sortProperties.@each', function(key, value) {
        ...
        if (content && isSorted) {
          ...
          content.sort((item1, item2) => self.orderBy(item1, item2));
          forEach(content, function(item) {
            forEach(sortProperties, function(sortProperty) {
    ...
    Ember.ArrayController = Ember.ArrayProxy.extend(Ember.ControllerMixin,
      ...
      */
      ...
      arrayContentDidChange(idx, removedCnt, addedCnt) {
        ...
        forEach(subControllersToRemove, subController => {
      ...
      _resetSubControllers() {
        ...
        forEach(subControllers, subController => {
          if (subController) { subController.destroy(); }
        });
  ...
  */
  if (Ember.$) {
    ...
    Ember.EnumerableUtils.forEach(dragEvents, eventName => {
  ...
  */
  ...
  var movesWhitespace = this.document && ((() => {
    var testEl = document.createElement('div');
  ...
  var setInnerHTMLWithoutFix = (element, html) => {
    if (needsShy) {
      html = '&shy;' + html;
    }
  ...
  function isSimpleClick(event) {
    var modifier = event.shiftKey || event.metaKey || event.altKey || event.ctrlKey; // IE9 may return undefined
  ...
  ((() => {
    ...
    */
    ...
    /**
      ...
      @constructor
    */
    Ember.RenderBuffer = tagName => new Ember._RenderBuffer(tagName);
    ...
    /** @scope Ember.RenderBuffer.prototype */ {
      ...
      */
      ...
      generateElement() {
        var // pop since we don't need to close
        tagName = this.tagNames.pop();
    ...
    /** @scope Ember.EventDispatcher.prototype */{
      ...
      */
      ...
      _bubbleEvent(view, evt, eventName) {
        return Ember.run(() => view.handleEvent(eventName, evt));
      },
  ...
  ((() => {
    ...
    */
    ...
    var childViewsProperty = Ember.computed(function() {
      ...
      ret.replace = (idx, removedCount, addedViews) => {
    ...
    */
    ...
    Ember.CoreView = Ember.Object.extend(Ember.Evented, {
      ...
      init() {
        ...
        this.addBeforeObserver('elementId', () => {
      ...
      */
      ...
      /**
        ...
        @param {Ember.RenderBuffer} buffer the render buffer. If no buffer is
          ...
          be used.
      */
      renderToBuffer(parentBuffer, bufferOperation) {
      ...
      _renderToBuffer(parentBuffer, bufferOperation) {
        Ember.run.sync();
    ...
    /** @scope Ember.View.prototype */ {
      ...
      */
      nearestOfType(klass) {
        ...
        var isOfType = klass instanceof Ember.Mixin ?
      ...
      */
      _applyClassNameBindings(classBindings) {
      ...
      */
      _applyAttributeBindings(buffer, attributeBindings) {
        var attributeValue;
        var elem;
        var type;
      ...
      invokeRecursively(fn) {
        ...
        while (childViews.length) {
          ...
          for (var i=0, l=currentViews.length; i<l; i++) {
            ...
            fn.call(view, view);
            if (view._childViews) {
              childViews.push(...view._childViews);
            }
          }
        }
      },

      triggerRecursively(eventName) {
        var childViews = [this];
        var currentViews;
        var view;
      ...
      */
      ...
      destroyAllChildren() {
        return this.mutateChildViews(view => {
          view.destroy();
        });
      },
    ...
    */
    ...
    Ember.View.reopenClass({
      ...
      */
      ...
      /**
        ...
        @static
      */
      _classStringForValue(path, val, className, falsyClassName) {
    ...
    Ember.View.addMutationListener = callback => {
      mutation.on('change', callback);
    };

    Ember.View.removeMutationListener = callback => {
    ...
    */
    ...
    Ember.View.applyAttributeBindings = (elem, name, value) => {
  ...
  */
  ...
  Ember.merge(preRender, {
    ...
    renderToBufferIfNeeded(view) {
      return view.renderToBuffer();
    },

    empty: Ember.K,

    setElement(view, value) {
      if (value !== null) {
  ...
  */
  ...
  define("metamorph",
    ...
    function() {
      ...
      var // Feature-detect the W3C range API, the extended check is for IE9 which only partially supports ranges
      supportsRange = document && ('createRange' in document) && (typeof Range !== 'undefined') && Range.prototype.createContextualFragment;

      var // Internet Explorer prior to 9 does not allow setting innerHTML if the first element
      // is a "zero-scope" element. This problem can be worked around by making
      // the first node an invisible text node. We, like Modernizr, use &shy;
      needsShy = document && ((() => {
        var testEl = document.createElement('div');
      ...
      var // IE 8 (and likely earlier) likes to move whitespace preceeding
      // a script tag to appear after it. This means that we can
      // accidentally remove whitespace when updating a morph.
      movesWhitespace = document && ((() => {
        var testEl = document.createElement('div');
        testEl.innerHTML = "Test: <script type='text/x-placeholder'></script>Value";
        return testEl.childNodes[0].nodeValue === 'Test:' &&
                testEl.childNodes[2].nodeValue === ' Value';
      ...
      if (supportsRange) {
         ...
         **/
        var firstNodeFor = (parentNode, html) => {
  ...
  (function() {
    ...
    */
    ...
    var objectCreate = Object.create || (parent => {
      function F() {}
      F.prototype = parent;
      return new F();
    });
    ...
    */
    ...
    /**
      ...
      @param string {String}
    */
    Ember.Handlebars.JavaScriptCompiler.prototype.appendToBuffer = string => "data.buffer.push("+string+");";
    ...
    */
    Ember.Handlebars.precompile = string => {
  ...
  /**
    ...
    @param data {Hash}
  */
  var normalizePath = Ember.Handlebars.normalizePath = (root, path, data) => {
  ...
  */
  var handlebarsGet = Ember.Handlebars.get = (root, path, options) => {
  ...
  Ember.Handlebars.resolveParams = (context, params, options) => {
    var resolvedParams = [];
  ...
  Ember.Handlebars.resolveHash = (context, hash, options) => {
    var resolvedHash = {};
  ...
  */
  Ember.Handlebars.registerBoundHelper = function(name, fn) {
    ...
    function helper(...args) {
      var properties = slice.call(args, 0, -1);
  ...
  */
  Ember.Handlebars.template = spec => {
  ...
  /**
    ...
    @static
  */
  Ember.String.htmlSafe = str => new Handlebars.SafeString(str);
  ...
  ((() => {
  Ember.Handlebars.resolvePaths = options => {
    var ret = [];
    ...
    for (var i=0, l=contexts.length; i<l; i++) {
      ret.push( Ember.Handlebars.get(roots[i], contexts[i], { data }) );
    }
  ...
  ((() => {
    ...
    */
    EmberHandlebars.registerHelper('bind', function(property, options) {
      ...
      return bind.call(context, property, options, false, result => !Ember.isNone(result));
    });
    ...
    */
    EmberHandlebars.registerHelper('with', function(context, options) {
      if (arguments.length === 4) {
        ...
        return bind.call(this, path, options, true, result => !Ember.isNone(result));
      } else {
    ...
    */
    EmberHandlebars.bindClasses = (context, classBindings, view, bindAttrId, options) => {
      var ret = [];
      var newClass;
      var value;
      var elem;
      ...
      // a Boolean or not.
      var classStringForPath = (root, parsedPath, options) => {
        var val;
        var path = parsedPath.path;
      ...
      // an observer.
      forEach.call(classBindings.split(' '), binding => {
        // Variable in which the old class value is saved. The observer function
        // closes over this variable, so it knows which string to remove when
        // the property changes.
        var oldClass;
  ...
  ((() => {
    ...
    */
    ...
    EmberHandlebars.ViewHelper = Ember.Object.create({
      ...
      propertiesFromHTMLOptions(options, thisContext) {
        var hash = options.hash;
        var data = options.data;
        var extensions = {};
      ...
      contextualizeBindingPath(path, data) {
      ...
      helper(thisContext, path, options) {
        var inverse = options.inverse;
        var data = options.data;
        var view = data.view;
        var fn = options.fn;
  ...
  ((() => {
    ...
    */
    Ember.Handlebars.registerHelper('collection', function(path, options) {
      ...
      var itemViewPath = hash.itemViewClass;
      ...
      var viewOptions = Ember.Handlebars.ViewHelper.propertiesFromHTMLOptions({ data, hash: itemHash }, this);
  ...
  ((() => {
    ...
    */
    Ember.Handlebars.registerHelper('log', function(property, options) {
      var context = (options.contexts && options.contexts[0]) || this;
      var normalized = normalizePath(context, property, options.data);
  ...
  ((() => {
    ...
    */
    ...
    var GroupedEach = Ember.Handlebars.GroupedEach = function(context, path, options) {
      ...
      this.containingView.on('willClearRender', () => {
        self.destroy();
      });
    };
    ...
    GroupedEach.prototype = {
      ...
      render() {
        ...
        for (var i = 0; i < contentLength; i++) {
          template(content.objectAt(i), { data });
        }
      },
  ...
  */
  ...
  Ember.Handlebars.registerHelper('template', function(name, options) {
    var view = options.data.view;
    var template = view.templateForName(name);
  ...
  */
  ...
  Ember.Handlebars.registerHelper('partial', function(name, options) {
    ...
    var deprecatedTemplate = view.templateForName(name);
    ...
    */
    Ember.Button = Ember.View.extend(Ember.TargetActionSupport, {
      ...
      */
      targetObject: Ember.computed(function() {
        var target = get(this, 'target');
        var root = get(this, 'context');
        var data = get(this, 'templateData');
  ...
  ((() => {
    ...
    */
    ...
    var get = Ember.get;
    var indexOf = Ember.EnumerableUtils.indexOf;
    var indexesOf = Ember.EnumerableUtils.indexesOf;
    var replace = Ember.EnumerableUtils.replace;
    ...
    Ember.Select = Ember.View.extend(
      ...
      defaultTemplate: Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
        ...
        function program1(depth0,data) {
          ...
          hashTypes = {};
          data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "view.prompt", {hash:{},contexts:[depth0],types:["ID"],hashTypes,data})));
        ...
        function program3(depth0,data) {
          ...
          data.buffer.push(escapeExpression(helpers.view.call(depth0, "Ember.SelectOption", {hash:{
            'contentBinding': ("this")
          },contexts:[depth0],types:["ID"],hashTypes,data})));
          }

        hashTypes = {};
        stack1 = helpers['if'].call(depth0, "view.prompt", {hash:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0],types:["ID"],hashTypes,data});
        if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
        hashTypes = {};
        stack1 = helpers.each.call(depth0, "view.content", {hash:{},inverse:self.noop,fn:self.program(3, program3, data),contexts:[depth0],types:["ID"],hashTypes,data});
        if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
        return buffer;
      }),
      ...
      */
      ...
      valueDidChange: Ember.observer(function() {
        ...
        if (value !== selectedValue) {
          selection = content.find(obj => value === (valuePath ? get(obj, valuePath) : obj));
  ...
  */
  ...
  /**
    ...
    @param ctx
  */
  Ember.Handlebars.bootstrap = ctx => {
    ...
    Ember.$(selectors, ctx)
      ...
      var // Get the name of the script, used by Ember.View's templateName property.
    ...
    () => {
      ...
      function findHandler(state, path) {
        ...
        for (var i=0, l=handlers.length; i<l; i++) {
          ...
          result.push({ handler: handler.handler, params, isDynamic: !!names.length });
        }
      ...
      RouteRecognizer.prototype = {
        add(routes, options) {
          ...
          for (var i=0, l=routes.length; i<l; i++) {
            ...
            handlers.push({ handler: route.handler, names });
          }
    ...
    RouteRecognizer => {
      ...
      Router.prototype = {
        ...
        */
        map(callback) {
          ...
          this.recognizer.map(callback, (recognizer, route) => {
        ...
        */
        paramsForHandler(handlerName, callback) {
        ...
        */
        generate(handlerName) {
          var params = this.paramsForHandler(...arguments);
        ...
        */
        _paramsForHandler(handlerName, objects, doUpdate) {
          var handlers = this.recognizer.handlersFor(handlerName);
          var params = {};
          var toSetup = [];
          var startIdx = handlers.length;
      ...
      */
      function collectObjects(router, results, index, objects) {
        ...
        if (object && typeof object.then === 'function') {
          ...
          object.then(proceed).then(null, error => {
      ...
      */
      function setupContexts(router, handlerInfos) {
        ...
        eachHandler(partition.exited, (handler, context) => {
          delete handler.context;
          if (handler.exit) { handler.exit(); }
        });

        eachHandler(partition.updatedContext, (handler, context) => {
          setContext(handler, context);
          if (handler.setup) { handler.setup(context); }
        });

        var aborted = false;
        eachHandler(partition.entered, (handler, context) => {
          if (aborted) { return; }
          if (handler.enter) { handler.enter(); }
          setContext(handler, context);
          if (handler.setup) {
  ...
  */
  ...
  Ember.controllerFor = (container, controllerName, context, lookupOptions) => container.lookup('controller:' + controllerName, lookupOptions) ||
  ...
  */
  Ember.generateController = (container, controllerName, context) => {
    ...
    controller.toString = () => "(generated " + controllerName + " controller)";
  ...
  ((() => {
    ...
    */
    ...
    function setupLocation(router) {
      ...
      var rootURL = get(router, 'rootURL');
    ...
    */
    Ember.Router = Ember.Object.extend({
      ...
      generate(...args) {
        var url = this.router.generate(...args);
    ...
    function getHandlerFunction(router) {
      ...
      var DefaultRoute = container.resolve('route:basic');
    ...
    */
    Ember.Route = Ember.Object.extend({
      ...
      */
      replaceWith(...args) {
        if (this._checkingRedirect) { this.redirected = true; }
        return this.router.replaceWith(...args);
      },

      send(...args) {
        return this.router.send(...args);
      },
    ...
    function teardownOutlet(parentView, outlet) {
      return () => { parentView.disconnectOutlet(outlet); };
    }
  ...
  ((() => {
    ...
    */
    ...
    var set = Ember.set;
    Ember.onLoad('Ember.Handlebars', Handlebars => {
      ...
      function resolvedPaths(options) {
        ...
        return resolveParams(options.context, options.params, { types, data });
      }
      ...
      **/
      var LinkView = Ember.LinkView = Ember.View.extend({
        ...
        active: Ember.computed(function() {
          ...
          var params = resolvedPaths(this.parameters);
          var currentWithIndex = this.currentWhen + '.index';

          var isActive = router.isActive(...[this.currentWhen].concat(params)) ||
                     router.isActive(...[currentWithIndex].concat(params));
        ...
        click(event) {
          ...
          if (this.get('replace')) {
            router.replaceWith(...args(this, router));
          } else {
            router.transitionTo(...args(this, router));
          }
        },

        href: Ember.computed(function() {
          var router = this.get('router');
          return router.generate(...args(this, router));
        })
      });

      LinkView.toString = () => "LinkView";
    ...
    Ember.onLoad('Ember.Handlebars', Handlebars => {
      ...
      */
      Ember.Handlebars.registerHelper('render', function(name, contextString, options) {
        ...
        if (root) {
          view.registerObserver(root, contextString, () => {
  ...
  */
  Ember.onLoad('Ember.Handlebars', Handlebars => {
    ...
    function args(options, actionName) {
      ...
      return ret.concat(resolveParams(options.context, options.params, { types, data }));
    }
    ...
    var isAllowedClick = (event, allowedKeys) => {
    ...
    ActionHelper.registerAction = (actionName, options, allowedKeys) => {
      ...
      ActionHelper.registeredActions[actionId] = {
        ...
        handler(event) {
          ...
          Ember.run(() => {
            if (target.send) {
              target.send(...args(options.parameters, actionName));
            } else {
              Ember.assert("The action '" + actionName + "' did not exist on " + target, typeof target[actionName] === 'function');
              target[actionName](...args(options.parameters));
            }
          });
        }
      };
    ...
    */
    EmberHandlebars.registerHelper('action', function(actionName) {
      ...
      action.target = { root, target, options };
  ...
  if (Ember.ENV.EXPERIMENTAL_CONTROL_HELPER) {
    ...
    */
    Ember.Handlebars.registerHelper('control', function(path, modelPath, options) {
      ...
      var children = get(controller, '_childContainers');
      var controlID = options.hash.controlID;
      var container;
      var subContainer;
      ...
      var childController = subContainer.lookup('controller:' + normalizedPath);
      var childTemplate = subContainer.lookup('template:' + path);
    ...
    Ember.HistoryLocation = Ember.Object.extend({
      ...
      */
      getURL() {
        ...
        var url = get(this, 'location').pathname;
  ...
  */
  ...
  DAG.prototype.add = function(name) {
    ...
    var vertex = {
      name, incoming: {}, incomingNames: [], hasOutgoing: false, value: null
    };
    ...
    Ember.DefaultResolver = Ember.Object.extend({
      ...
      */
      resolve(fullName) {
        ...
        var typeSpecificResolveMethod = this[parsedName.resolveMethodName];
  ...
  ((() => {
    ...
    */
    ...
    function verifyDependencies(controller) {
      var needs = get(controller, 'needs');
      var container = get(controller, 'container');
      var dependency;
      var satisfied = true;
    ...
    */
    ...
    /** @scope Ember.State.prototype */{
      ...
      */
      trigger(name) {
        if (this[name]) {
          this[name](...[].slice.call(arguments, 1));
        }
        this._super(...arguments);
      },
      ...
      */
      ...
      transitionTo(target) {
        ...
        var transitionFunction = function(stateManager, contextOrEvent) {
          ...
          stateManager.transitionTo(...contexts);
        };
  ...
  ((() => {
    ...
    */
    ...
    var sendRecursively = function(event, currentState, isUnhandledPass) {
      ...
      var eventName = isUnhandledPass ? 'unhandledEvent' : event;
      var action = currentState[eventName];
      var contexts;
      var sendRecursiveArguments;
      var actionArguments;
    ...
    Ember.StateManager = Ember.State.extend({
      ...
      */
      ...
      triggerSetupContext(transitions) {
        ...
        var offset = transitions.enterStates.length - contexts.length;
        var enterStates = transitions.enterStates;
        var transitionEvent = get(this, 'transitionEvent');
